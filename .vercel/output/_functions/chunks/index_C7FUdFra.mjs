...
import { A as maybeRenderHead, D as renderTemplate, I as createComponent, M as addAttribute, T as renderComponent } from "./fetch-state_BoCD520l.mjs";
import "./compiler_DyFx8Fte.mjs";
import { n as t, r as getCollection, t as $$BaseLayout } from "./BaseLayout_BAJbFXZN.mjs";
...
var $$Index = createComponent(async ($$result, $$props, $$slots) => {
	...
	}, { "default": ($$result) => renderTemplate`${maybeRenderHead($$result)}<main class="pt-24 pb-24"><div class="section-container"><h1 class="section-title mb-12">Blog</h1><div class="max-w-3xl mx-auto space-y-6">${sorted.map((post) => renderTemplate`<a${addAttribute(`/blog/${post.id}`, "href")} class="block group rounded-2xl border border-border bg-card p-6 hover:glow-sm transition-all duration-300"><div class="flex items-center gap-4 text-sm text-muted-foreground mb-3"><time${addAttribute(post.data.date.toISOString(), "datetime")}>${post.data.date.toLocaleDateString("es-ES", {
		year: "numeric",
		month: "long",
		day: "numeric"
